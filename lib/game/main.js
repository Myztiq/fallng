...
MyGame = ig.Game.extend({
  ...
  update: function() {
    ...
    var curScreenTop = (this.screen.y / bg.distance); // game to image bg 
    var totalBgHeight = (bg.data.length * 800); // in image bg coords
    // console.log(curScreenTop + " " + totalBgHeight);
    ...
    var stopHeight = totalBgHeight - viewPortHeight;
    // console.log(stopHeight);
    if ( !this.isDone && curScreenTop < stopHeight )
    {
      var maxRange = 140;
      ...
      var screenTop =this.screen.y + viewPortHeight;
      console.log("Screen Top: " + screenTop);
    }
    else if (!this.isDone)
    {
      var totalBgHeightPixels = totalBgHeight * bg.distance;
      this.screen.y = totalBgHeightPixels - viewPortHeight;
      var screenTop =this.screen.y + viewPortHeight;
      console.log("Final Screen Top: " + screenTop);
      this.isDone = true;
    }
