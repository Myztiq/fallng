  ...
  .defines(function(){
    ...
    MyGame = ig.Game.extend({
      ...
      init: function() {
        ...
        bgMountainMap.preRender = true;
        bgMountainMap.chunkSize = 800;
        ...
        bgMountainCloseMap.preRender = true;
        bgMountainCloseMap.chunkSize = 800;
        ...
        this.updateParachuteCount( this.player.parachuteCount );
      ...
      update: function() {
        ...
        var maxScreenHeight = totalBgHeight - window.gameHeight * bg.distance;
        ...
        if(Math.random() > .8 && this.currentLevel == 'thermosphere'){
          this.spawnEntity(EntityStars, Math.random()*800, this.player.pos.y + 1000);
        }
        if(Math.random() > .99 && this.currentLevel == 'stratosphere'){
          this.spawnEntity(EntityAurorae, 0, this.player.pos.y + 1000);
        }
        if(Math.random() > .99 && (this.currentLevel == 'upperAtmosphere' || this.currentLevel == 'cityScape')){
          this.spawnEntity(EntityCloud, 0, this.player.pos.y + 1000);
        }
        //Spawn shit
        if(Math.random() > .95 && this.spawnPosition < this.player.pos.y + 1000){
          this.spawnPosition = this.player.pos.y + 1000 + Math.random() * 200;
      ...
      updateParachuteCount: function (count) {
        /* changes the view */
        $('#parachute-count').html(count);
      }
    });
