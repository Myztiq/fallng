    ...
    MyGame = ig.Game.extend({
      ...
      update: function() {
        ...
        if(Math.random() > .8 && this.currentLevel == 'thermosphere'){
          this.spawnEntity(EntityStars, Math.random()*800, this.player.pos.y + 1400);
        }
        if(Math.random() > .99 && this.currentLevel == 'stratosphere'){
          this.spawnEntity(EntityAurorae, 0, this.player.pos.y + 1400);
        }
        if(Math.random() > .99 && (this.currentLevel == 'upperAtmosphere' || this.currentLevel == 'cityScape')){
          this.spawnEntity(EntityCloud, 0, this.player.pos.y + 1400);
        }
        //Spawn shit
